...
%
% EXK: 11/08/2009
% structure             structure of PSA. It can be one of
%                       'unstructured'
%                       'real'
%                       'skew-symmetric'
%                       'Hermitian'
...
global pause_comp;
global stop_comp;
if isempty(pause_comp), pause_comp(fig.Number) = 0; end;
if isempty(stop_comp), stop_comp(fig.Number) = 0; end;
...
%% User has selected a demo option
    ps_data = switch_demo(fig.Number,ps_data,the_demo);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  case {'unstructured','real','skew-symmetric','Hermitian','Hamiltonian'}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
