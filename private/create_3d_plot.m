...
% function create_3d_plot(fig)
%
% Function to create a 3d plot from the current structured
% pseudospectra data. Also called when the plot options are
% changed using the menu in a 3D plot figure.
