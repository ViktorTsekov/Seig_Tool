...
set(h0,'Name','Structured EigTool');
...
h2 = uimenu('Parent',h1, ...
        ...
        'Label','Display Structured &Pseudospectra', ...
        'Tag','DisplayPSA');
h2 = uimenu('Parent',h1, ...
...
h2 = uimenu('Parent',h1, ...
        'Callback','', ...
        'Label','Hamiltonian example 1', ...
        'Tag','DemoHamiltonian1');
h3 = uimenu('Parent',h2, ...
        'Callback','eigtool_switch_fn(''DemoHamiltonian1S'')', ...
        'Label','&Compute Hamiltonian pseudospectra', ...
        'Tag','Hamiltonian1PSAs');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
h2 = uimenu('Parent',h1, ...
        'Callback','', ...
        'Label','Hamiltonian example 2', ...
        'Tag','DemoHamiltonian2');
h3 = uimenu('Parent',h2, ...
        'Callback','eigtool_switch_fn(''DemoHamiltonian2S'')', ...
        'Label','&Compute Hamiltonian pseudospectra', ...
        'Tag','Hamiltonian2PSAs');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
h2 = uimenu('Parent',h1, ...
        'Callback','', ...
        'Label','Hermitian example', ...
        'Tag','DemoHermitian');
h3 = uimenu('Parent',h2, ...
        'Callback','eigtool_switch_fn(''DemoHermitianS'')', ...
        'Label','&Compute Hermitian pseudospectra', ...
        'Tag','HermitianPSAs');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
h2 = uimenu('Parent',h1, ...
        ...
        'Tag','DemoRump');
h3 = uimenu('Parent',h2, ...
        'Callback','eigtool_switch_fn(''DemoRumpS'')', ...
        'Label','&Compute skew-symmetric pseudospectra', ...
        'Tag','RumpPSAs');
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
the_messages = { ...
  'Structured EigTool: left button to zoom in, right button to zoom out',
  ...
  'Click close to return to Structured EigTool...',
  ...
  'Structured EigTool: a graphical tool for structured pseudospectra',
  ...
  'Structured EigTool: please wait...',
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','eigtool_switch_fn(''unstructured'');', ...
	'Enable','on', ...
	'HorizontalAlignment','left', ...
	'ListboxTop',0, ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','eigtool_switch_fn(''real'');', ...
	'Enable','on', ...
	'HorizontalAlignment','left', ...
	'ListboxTop',0, ...
	'Position',[235   75   95   22.32941], ... % mpe edit
	'Style','radio', ...
        'String','real', ...
	'Tag','real', ...
        'Value',0);
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','eigtool_switch_fn(''skew-symmetric'');', ...
	'Enable','on', ...
	'HorizontalAlignment','left', ...
	'ListboxTop',0, ...
	'Position',[235   55   95   22.32941], ... % mpe edit
	'Style','radio', ...
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','eigtool_switch_fn(''Hermitian'');', ...
	'Enable','on', ...
	'HorizontalAlignment','left', ...
	'ListboxTop',0, ...
	'Position',[235   35   95   22.32941], ... % mpe edit
	'Style','radio', ...
        'String','Hermitian', ...
	'Tag','Hermitian', ...
        'Value',0);	
...
h1 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',[1 1 1], ...
	'Callback','eigtool_switch_fn(''Hamiltonian'');', ...
	'Enable','on', ...
	'HorizontalAlignment','left', ...
	'ListboxTop',0, ...
	'Position',[235   15   95   22.32941], ... % mpe edit
	'Style','radio', ...
        'String','Hamiltonian', ...
	'Tag','Hamiltonian', ...
        'Value',0);	
